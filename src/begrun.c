...
#ifdef HUBBLE_TABLE
      All.MeHubbleSpline = all.MeHubbleSpline;
      All.MeHubbleAcc = all.MeHubbleAcc;
#endif
#ifdef DMMASS_TABLE
      All.MeDMMassSpline = all.MeDMMassSpline;
      All.MeDMMassAcc = all.MeDMMassAcc;
#endif
#ifdef DRAG_TABLE
      All.MeDRAGSpline = all.MeDRAGSpline;
      All.MeDRAGAcc = all.MeDRAGAcc;
#endif
#ifdef DE_TABLE
      All.MeDESpline = all.MeDESpline;
      All.MeDEAcca = all.MeDEAcca;
      All.MeDEAcck = all.MeDEAcck;
#endif
#ifdef VARG_TABLE
      All.MeVARGSpline = all.MeVARGSpline;
      All.MeVARGAcc = all.MeVARGAcc;
#endif
