...
extern int HUBBLE_TABLE_LENGTH; /*!< the look up table used to hold the hubble parameter*/
extern int DMMASS_TABLE_LENGTH; /*!< the loop up table used to hold the dark matter particle mass*/
extern int DRAG_TABLE_LENGTH;   /*!< the look up table used to hold the drag force*/
extern int VARG_TABLE_LENGTH;   /*!< the look up table used to hold the variable G/Gnewton*/
...
#ifdef HUBBLE_TABLE
extern gsl_spline *MeHubbleSplineDRIFT;
extern gsl_spline *MeHubbleSplineGRAVKICK;
extern gsl_spline *MeHubbleSplineHYDROKICK;
#endif
...
#endif
#ifdef DRAG_TABLE
  gsl_interp_accel *MeDRAGAcc;
  gsl_spline *MeDRAGSpline;
#endif
#ifdef DE_TABLE
  gsl_interp_accel *MeDEAcca;
  gsl_interp_accel *MeDEAcck;
  gsl_spline2d *MeDESpline;
#endif
#ifdef VARG_TABLE
  gsl_interp_accel *MeVARGAcc;
  gsl_spline *MeVARGSpline;
#endif
  /* some filenames */
