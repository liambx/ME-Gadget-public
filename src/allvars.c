...
int HUBBLE_TABLE_LENGTH; /*!< the look up table used to hold the hubble parameter*/
int DMMASS_TABLE_LENGTH; /*!< the loop up table used to hold the dark matter particle mass*/
int DRAG_TABLE_LENGTH;   /*!< the look up table used to hold the drag force*/
int VARG_TABLE_LENGTH;   /*!< the look up table used to hold the variable G/Gnewton*/
...
#ifdef HUBBLE_TABLE
gsl_spline *MeHubbleSplineDRIFT;
gsl_spline *MeHubbleSplineGRAVKICK;
gsl_spline *MeHubbleSplineHYDROKICK;
#endif
